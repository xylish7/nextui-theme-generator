...
function generateThemeColorsConfig(config: Config, theme: ThemeType) {
  return {
    default: generateThemeColor(
      config[theme].brandColor.default,
      "default",
      "light"
    ),
    primary: generateThemeColor(
      config[theme].brandColor.primary,
      "primary",
      "light"
    ),
    secondary: generateThemeColor(
      config[theme].brandColor.secondary,
      "secondary",
      "light"
    ),
    success: generateThemeColor(
      config[theme].brandColor.success,
      "success",
      "light"
    ),
    warning: generateThemeColor(
      config[theme].brandColor.warning,
      "warning",
      "light"
    ),
    danger: generateThemeColor(
      config[theme].brandColor.danger,
      "danger",
      "light"
    ),
    background: config[theme].baseColor.background,
    foreground: generateThemeColor(
      config[theme].baseColor.foreground,
      "foreground",
      "light"
    ),
    content1: {
